...
---
A recent article by Bird & Bird delves into the practical aspects of using qualified electronic signatures (QES) in Poland. This method of signing documents electronically has been around for over 20 years but is only now becoming widely used. According to the Civil Code, documents signed with a QES are legally equal to documents signed by hand.
